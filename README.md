...
-   Tutaj ryzykiem jest lęk przed delegowaniem obowiązków
    -   Ulegamy pokusie mikrozarządzania
        -   Twój umysł zaprzątają szczegóły
        -   Spory pomiędzy dworzanami
        -   dezorientacja przesącza się do grupy
-   Rozwiązaniem jest stworzenie zespołu asystentów
    -   kolektywnych i przesiąkinietych poczuciem celu
    -   możesz zaufać ich kompetencji
-   Wybierając asystentów
    -   Nie kieruj się urokiem
    -   Nie zatrudniaj przyjaciół
    -   Potrzebujesz kompetencji oraz dobrego charakteru
...
-   wspomaganie zachowania spokoju zespołu jest znacznie bardziej efektywne niż rozkręcanie emocji
    -   pomaga na skupieniu się na zadaniu
    -   broni przed przesadnym reagowaniem na zmiany atmosfery
    -   pomaga się przekonać o poprawnie wykonywanej pracy
    -   wycisza zespół
-   zarażaj grupę poczuciem zdecydowania, którym powinnieneś emanować jako lider
    -   musisz dawać wrażenie osoby która nie odstręczają niepowodzenia
    -   stale posuwa się na przód i pracuję nad rozwiązywaniem problemów
-   bądź wytrwały
    -   grupa to wyczuwa
    -   ich członków wprawia w zakłopotanie że wpadają w histerie w obliczu najdrobniejszych przeciwności losu
-   zarażaj grupę pewnością siebie
    -   Uwaga! Należy być ostrożnym aby nie zamieniało się to w megalomanie
    -   Twoje pewność siebie oraz grupy powinna wynikać z poczucia zadowolenie z naszych wspólnych osiągnięć
-   zmieniaj i zaskakuj grupę nowymi i wymagającymi zadaniami
    -   będzie to pobudzać członków i pozbawiać samozadowolenia
        -   samozadowolenie wkrada się do każdego zespołu który osiąga sukces
-   demonstruj brak lęku i otwartość na nowe koncepcje
    -   wywołuje terpeutyczny efekt
...
-   Musisz dobrze poznać swoją grupę
    ...
    -   maksimum jakiego można się po nich spodziewać
-   pozory mogą być mylące
    -   w codziennej pracy ludzie mogą wydawać się zmotywowani, skupieni i produktywni
    -   natomiast w momencie jak pojawia się stres, przeciwności losu to możemy zauważyc ich zupełnie odmienne obliczę
        -   niektórzy myślą o sobie i odłączają się od ducha grupy
        -   inni odczuwają niepokój i zasczepiają grupie swoje lęki
-   Potrzebujesz panować na faktyczną siłą Twojego zespołu
    -   Oszacować względną wewnętrzną wytrzymałość swoich ludzi zanim dojdzie do kryzysu
    -   Powierzaj różnym członkom grupy stosunkowo trudne zadania lub ustalaj krótsze niż zwykle terminy
        -   obserwuj jak będą reagować
...
-   Twoim ostatecznym celem jest stworzenie grupy która uczestniczyła w kilku starciach i poradziłą sobie w ich trakcie całkiem dobrze
    -   można grupe uznać za sprawdzoną w boju
...
-   Zapamiętaj! Często skupiwamy się na problemach psychicznych jednostek, natomiast zapominamy że to grupa może mieć wpływ na ich zachowanie
    ...
    -   natomiast co istotne to działa też odwrotnie
        -   działajać w ramach wysoce skutecznej grupie realnej możemy sprawić że będziemy zdrowi i spełnieni
            -   takie doświadczenia bywają niezpomniane i zmieniają nasze życie
            -   uczymy się jaką wartość ma ścisła współpraca
            -   nasz los jest powiązany z losem otaczających nas ludzi
            -   pogłębiamy naszą empatie
            -   zwiększamy zaufanie do naszych umiejętności co grupa nam wynagradza
            -   odczuwamy związek z rzeczywistością
            -   odczuwamy pozytywną presje grupy
